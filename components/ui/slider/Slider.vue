...
<template>
  <div class="flex h-10">
    ...
    >
      <SliderTrack
        class="relative h-2 w-full grow overflow-hidden rounded-full bg-slate-100 dark:bg-slate-950"
      >
        <SliderRange
          class="absolute h-full bg-secondary-900 dark:bg-secondary-600"
        />
      </SliderTrack>
      <SliderThumb
